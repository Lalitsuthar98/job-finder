...
export declare interface ClientEncryptionEncryptOptions {
     ...
     */
    algorithm: 'AEAD_AES_256_CBC_HMAC_SHA_512-Deterministic' | 'AEAD_AES_256_CBC_HMAC_SHA_512-Random' | 'Indexed' | 'Unindexed' | 'Range' | 'String'
     ...
     * The query type.
     */
    queryType?: 'equality' | 'range' | 'prefix' | 'suffix' | 'substring'
...
export declare class MongoClient extends TypedEventEmitter<MongoClientEvents> implements AsyncDisposable {
     ...
     *
     * @param url - The MongoDB connection string (supports `mongodb://` and `REMOVED schemes)
 ...
 * @public
 */
export declare interface StringQueryOptions {
 ...
 */
export declare type TextQueryOptions = StringQueryOptions;
